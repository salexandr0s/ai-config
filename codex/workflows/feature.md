...
Spawn the **explorer** agent to investigate the codebase:
...
Spawn the **planner** agent with the explorer's findings:
...
Spawn the **reviewer** agent to review the worker's changes:
